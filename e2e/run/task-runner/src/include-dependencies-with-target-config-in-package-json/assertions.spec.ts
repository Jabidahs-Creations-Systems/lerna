...
describe("lerna-run-nx-include-dependencies-with-target-config-in-package-json", () => {
  ...
  it("should exclude dependencies by default", async () => {
    ...
    expect(output).toMatchInlineSnapshot(`
      ...
      lerna verb rootPath /tmp/lerna-e2e/lerna-run-nx-include-dependencies-with-target-config-in-package-json/lerna-workspace
